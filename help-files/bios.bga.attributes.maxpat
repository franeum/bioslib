...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 5,
					"outlettype" : [ "list", "int", "float", "int", "list" ],
					"patching_rect" : [ 15.0, 240.0, 277.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 195.0, 360.0, 277.0, 20.0 ],
					"text" : "bios.BGA @popsize 200 @numvar 10 @varsize 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 135.0, 214.0, 51.0 ],
					"text" : "size (in bit) for each var. In this example each var can take values between 0 and 31",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 135.0, 150.0, 20.0 ]
				}
