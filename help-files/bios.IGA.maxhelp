...
, 			{
				"box" : 				{
					...
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "bios.iga.attributes.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 90.0, 585.0, 450.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "bios.IGA --- Integer Genetic Algorithm"
				}
