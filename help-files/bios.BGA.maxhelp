...
, 			{
				"box" : 				{
					...
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "bios.bga.attributes.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 90.0, 585.0, 450.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"tabs" : [ "overview", "attributes", "messages", "fitness", "output", "test", "example" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 28.5, 570.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 7.5, 555.0, 33.0 ],
					"text" : "bios.BGA --- Binary Genetic Algorithm"
				}
