...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"maxclass" : "bpatcher",
					"name" : "bios.cloneiga.overview.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"maxclass" : "bpatcher",
					"name" : "bios.cloneiga.example.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 90.0, 585.0, 450.0 ],
					"varname" : "fourth"
...
, 			{
				"box" : 				{
					...
					"id" : "obj-8",
					"maxclass" : "bpatcher",
					"name" : "bios.cloneiga.output.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 90.0, 585.0, 450.0 ],
					"varname" : "third"
...
, 			{
				"box" : 				{
					...
					"id" : "obj-36",
					"maxclass" : "bpatcher",
					"name" : "bios.cloneiga.messages.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 90.0, 585.0, 450.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "bios.cloneiga.attributes.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 90.0, 585.0, 450.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 180.0, 105.0, 210.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 90.0, 120.0, 105.0 ],
					"rounded" : 0.0,
					"tabcolor" : [ 0.897211, 0.897211, 0.897211, 1.0 ],
					"tabs" : [ "overview", "attributes", "messages", "output", "example" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 31.5, 690.0, 27.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 15.0, 7.5, 586.0, 47.0 ],
					"text" : "bios.cloneIGA --- Int Genetic Algorithm with cloned population"
				}
